...
# `site/` is the landing page. The workflows this classifier replaces already
# carried `'!site/**'`, so it was prose to them too; it is rendered and checked
# by docs-site.yml, which a site/ change triggers.
#
...
def self_test() -> int:
    ...
    cases: list[tuple[str, bool, str]] = [
        ...
        ("M\tsite/index.html", True, "the landing page is rendered by docs-site"),
        ("D\tsite/index.html", False, "a deleted page is never the cheap lane"),
